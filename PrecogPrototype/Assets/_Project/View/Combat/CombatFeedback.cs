...
namespace Game.View
{
    ...
    public class CombatFeedback : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            PlayerActionPhase action = w.player.combat.phase;
            if (action != prevAction && action == PlayerActionPhase.LungeTravel) AddShake(0.14f);
            prevAction = action;
        }
